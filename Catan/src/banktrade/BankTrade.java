 ...
 * 
 * The active player can add and remove cards from their hand by clicking the corresponding buttons.
 * When the button "ok" is clicked, the cards are added and removed from their hand.
 * For future coding the Manager class should first check whether the trade is allowed.
 */
public class BankTrade {
    ...
    public static void main (String[] args){ 
    	javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	frame = new JFrame("Trade with Bank");
    ...
    public static Map<String, Integer> buttonTrade(final JFrame frame1 ,String card, final JLabel label, Map<String, Integer> data) { 
