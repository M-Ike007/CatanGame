...
public class CostTable {
	...
	private static Hashtable<String, Hashtable<String, Integer>> costTable = new Hashtable<String, Hashtable<String, Integer>>();
	
	private static Hashtable<Structures, Hashtable<String, Integer>> structuresTable = new Hashtable<Structures, Hashtable<String, Integer>>();
	
	private Hashtable<String, Integer> road_cost = new Hashtable<String, Integer>();
	private Hashtable<String, Integer> village_cost = new Hashtable<String, Integer>();
	private Hashtable<String, Integer> city_cost = new Hashtable<String, Integer>();
	private Hashtable<String, Integer> development_card_cost = new Hashtable<String, Integer>();
	...
	/**A Method to retrieve the private variables Structure Costs
	 * @param request, a item of the Structures enum
	 * @return Hashtable<String, Integer>.
	 */
	public Hashtable<String, Integer> getStructureCost(Structures request) {
		Hashtable<String, Integer> requested_cost = structuresTable.get(request);
		return requested_cost;
		
	}
	
	
	/** Printing the cost table to the sys out.
	 */
