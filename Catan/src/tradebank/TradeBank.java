 ...
 * 
 * This class opens a window that asks the player whether they want to trade
 * with the bank and if so, what.
 */
...
public class TradeBank extends JFrame {
	...
	/**
	 * This method creates a frame and asks the active player if he will trade with
	 * the bank. If the player wants to trade, the first choice is which resource he
	 * want to give to the bank. The second choice is which resource he want to
	 * receive. Then the player can trade again or leave the screen.
	 * 
	 ...
	 * @param amount:   the amount of resource that change in the active player
	 *                  hand.
	 */
	...
	/**
	 * This method trades the wool resource with the bank. The first click on the
	 * button removes 4 wool resources of the active player hand. The second click
	 * on the button add 1 wool resource of the active player hand.
	 */
	...
	/**
	 * This method trades the ore resource with the bank. The first click on the
	 * button removes 4 ore resources of the active player hand. The second click on
	 * the button add 1 ore resource of the active player hand.
	 */
	...
	/**
	 * This method trades the brick resource with the bank. The first click on the
	 * button removes 4 brick resources of the active player hand. The second click
	 * on the button add 1 brick resource of the active player hand.
	 */
	...
	/**
	 * This method trades the wood resource with the bank. The first click on the
	 * button removes 4 wood resources of the active player hand. The second click
	 * on the button add 1 wood resource of the active player hand.
	 */
	...
	/**
	 * This method trades the wheat resource with the bank. The first click on the
	 * button removes 4 wheat resources of the active player hand. The second click
	 * on the button add 1 wheat resource of the active player hand.
	 */
