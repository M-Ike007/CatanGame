 ...
 * 
 * In this class, the game is ran and the order of the players is decided. The
 * players are initialised and given a hand. The Main also initialises a single
 * die. The phases as set out in the game package are implemented here.
 */
public class Main {
	 ...
	 * 
	 * This class gets the size of the players List to check the number of players
	 */
	public int getSize() {
	...
	/**
	 * Dummy throw. A method to set dice roll result ahead of time.
	 * 
	 * @param dummy A list with the length of the number of players precipitating,
	 *              each number is the list, is the result of the dice throw given
	 *              to that player.
	 * @return throwmap A map of players and corresponding dummy dice throw. The
	 *         dummy throw is an int which is the index of said player.
	 */
	 ...
	 *                 contains the identity of each player, and the result of each
	 *                 throw.
	 * 
	 * 
	 * @return throwmap An empty map to indicate that there is no player order when
	 *         status == END.
	 * @return tempmap A map of the player turns in ascending or descending order of
	 *         throw value.
	 */
